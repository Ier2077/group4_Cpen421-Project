        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <fieldset>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input value={form.citizen_name} onChange={(e) => set('citizen_name', e.target.value)} className="input-field" required />
              </div>
              <div>
                <label className="label">Phone Number</label>
                <input value={form.citizen_phone} onChange={(e) => set('citizen_phone', e.target.value)} className="input-field" placeholder="+233…" />
              </div>
            </div>
          </fieldset>
          ...
          <fieldset>
            ...
            <div className="space-y-4">
              ...
              {/* Hidden lat/lng still available for manual entry if needed */}
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Set by clicking map"
                    readOnly
                  />
                </div>
                <div>
